...
class OODBBean implements \IteratorAggregate,\ArrayAccess,\Countable,Jsonable
{
	...
	*/
	 ...
	 * Routes call to AppModel. If the model implements a __toString() method this
...
{
	/**
	 * Factory function to create instance of Simple AppModel, if any.
	 *
	 * @var callable|NULL
	 */
	 ...
	 * the instance of the Simple AppModel.
	 *
...
{
	/**
	 * AppModel prefix to be used for the current database connection.
	 *
	 * @var string
	 */
	private $modelPrefix;
...
/**
 * SimpleModel
 * Base AppModel For All RedBeanPHP Models using FUSE.
 *
...
class SimpleModel
{
	 ...
	 * OODBBean. The method returns a RedBeanPHP Simple AppModel.
...
class SimpleModelHelper implements Observer
{
	...
	/**
	 * Attaches the FUSE event listeners. Now the AppModel Helper will listen for
...
class Facade
{
	...
	*/
	 ...
	 * @return integer
	 */
	public static function getCellexec( $sql, $bindings = array() )
	{
...
if ( !function_exists( 'DBPrefix' ) ) {
	...
	function DBPrefix( $prefix = '\\AppModel' ) {
